...
const FAQS = [
  ...
  ['Is Journey Tracker free? How does the trial work?', "Yes. Journey Tracker is free to download and has a free version: the last 90 days of weight history, dose, symptom, fasting, and water logging, your two most recent lab visits, Strides, two PDF reports, and iCloud sync. Journey Tracker Pro adds your full history, every lab visit, all reports, widgets, and more — with a 7-day free trial on monthly and annual plans, or a one-time lifetime purchase. Billing is handled privately through your Apple ID."],
  ...
  ['What devices are supported?', 'Journey Tracker is built for iPhone and iPad, with iCloud sync keeping them in step. It requires iOS 18 or later.'],
