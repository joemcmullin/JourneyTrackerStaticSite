...
const TIERS = [
  {
    name: 'Free',
    tag: 'Start here',
    blurb: 'The essentials are free.',
    features: [
      'Last 90 days of weight history',
      'Dose, symptom & fasting logs',
      'Two latest lab visits',
      'Strides & iCloud sync',
    ],
    cta: 'Download free',
    featured: false,
  },
  {
    ...
    features: [
      ...
      'Every lab visit & weekly summary',
      'Unlimited progress photos & victories',
      'Imports & widgets',
